...
public class ASIGNACION {
     public void ejecutarReporte(String dep, String user, String asig){
        CONEXION mysql = new CONEXION();
        Connection cn = (Connection) mysql.Conectar();
        try {
            String archivo = System.getProperty("user.dir")+"/src/REPORTES/Asignacion.jasper";//System.getProperty("user.dir")+"/src/REPORTE/Reporte.jasper"
