 ...
 */
public class RECEP {
     public void ejecutarReporte(String dep, String asig){
        CONEXION mysql = new CONEXION();
        Connection cn = (Connection) mysql.Conectar();
        try {
            String archivo = System.getProperty("user.dir")+"/src/REPORTES/RECEPCION.jasper";//System.getProperty("user.dir")+"/src/REPORTE/Reporte.jasper"
